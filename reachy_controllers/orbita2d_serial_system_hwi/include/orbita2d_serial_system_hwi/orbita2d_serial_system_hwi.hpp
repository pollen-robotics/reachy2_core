#ifndef _ORBITA2D_SERIAL_SYSTEM_HWI
#define _ORBITA2D_SERIAL_SYSTEM_HWI
...
class Orbita2dSerialSystem : public hardware_interface::SystemInterface
{
public:
    RCLCPP_SHARED_PTR_DEFINITIONS(Orbita2dSerialSystem)
...
#endif // _ORBITA2D_SERIAL_SYSTEM_HWI
