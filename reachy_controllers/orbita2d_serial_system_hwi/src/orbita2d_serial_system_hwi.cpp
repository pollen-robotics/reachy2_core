#include "orbita2d_serial_system_hwi/orbita2d_serial_system_hwi.hpp"

#include "orbita2d_serial_hwi.h"
...
namespace orbita2d_serial_system_hwi
{
CallbackReturn
Orbita2dSerialSystem::on_init(const hardware_interface::HardwareInfo & info)
{
...
CallbackReturn
Orbita2dSerialSystem::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  orbita2d_serial_hwi_get_goal_orientation(this->uid, hw_commands_position_);
//   orbita2d_serial_hwi_get_max_speed(this->uid, hw_commands_speed_limit_);
  ...
  orbita2d_serial_hwi_is_torque_on(this->uid, hw_commands_torque_);
...
CallbackReturn
Orbita2dSerialSystem::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{
  RCLCPP_INFO(
    rclcpp::get_logger("Orbita2dSerialSystem"),
...
Orbita2dSerialSystem::export_state_interfaces()
{
...
Orbita2dSerialSystem::export_command_interfaces()
{
...
Orbita2dSerialSystem::read(const rclcpp::Time &, const rclcpp::Duration &)
{
  ...
  // if (orbita2d_serial_hwi_get_temperature(this->uid, hw_states_temperature_) != 0) {
  //     RCLCPP_INFO_THROTTLE(
  //       rclcpp::get_logger("Orbita2dSerialSystem"),
  //       clock_,
  //       LOG_THROTTLE_DURATION,
  ...
  // if (orbita2d_serial_hwi_get_max_torque(this->uid, hw_states_torque_limit_) != 0) {
  //   RCLCPP_INFO_THROTTLE(
  //     rclcpp::get_logger("Orbita2dSerialSystem"),
  //     clock_,
  //     LOG_THROTTLE_DURATION,
  ...
  //   );
  // }
//   if (orbita2d_serial_hwi_get_max_speed(this->uid, hw_states_speed_limit_) != 0) {
//     RCLCPP_INFO_THROTTLE(
//       rclcpp::get_logger("Orbita2dSerialSystem"),
//       clock_,
//       LOG_THROTTLE_DURATION,
...
//     );
//   }
  if (orbita2d_serial_hwi_is_torque_on(this->uid, hw_states_torque_) != 0) {
      RCLCPP_INFO_THROTTLE(
        rclcpp::get_logger("Orbita2dSerialSystem"),
        clock_,
        LOG_THROTTLE_DURATION,
...
//   if (orbita2d_serial_hwi_get_pid(this->uid, hw_states_p_gain_, hw_states_i_gain_, hw_states_d_gain_) != 0) {
//     RCLCPP_INFO_THROTTLE(
//       rclcpp::get_logger("Orbita2dSerialSystem"),
//       clock_,
//       LOG_THROTTLE_DURATION,
...
Orbita2dSerialSystem::write(const rclcpp::Time &, const rclcpp::Duration &)
{
  ...
  // if (orbita2d_serial_hwi_set_target_orientation_max_speed_max_torque(
  //   this->uid, 
  //   hw_commands_position_,
...
//   if (orbita2d_serial_hwi_set_pid(this->uid, hw_commands_p_gain_, hw_commands_i_gain_, hw_commands_d_gain_) != 0) {
//     RCLCPP_INFO_THROTTLE(
//       rclcpp::get_logger("Orbita2dSerialSystem"),
//       clock_,
//       LOG_THROTTLE_DURATION,
...
PLUGINLIB_EXPORT_CLASS(
  orbita2d_serial_system_hwi::Orbita2dSerialSystem,
